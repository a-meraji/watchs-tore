...
متنوع ترین مجموعه ساعت ها
<br/>
برای همه ی اقشار و سلیقه ها 
              </p>
            </div>
            <div>
              <div className="mt-10">
                ...
                >
                  <div className="absolute transform sm:right-1/2 sm:top-0 sm:translate-x-8 lg:right-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8">
